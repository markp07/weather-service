 ...
 * <p>
 * Handles {@link GenericException} and generic {@link Exception}. Returns a structured
 * {@link Error} response with appropriate HTTP status and error details.
 * </p>
 * <ul>
...
public class CustomExceptionHandler {
  ...
  /**
   * Handles {@link GenericException}. Logs the exception and returns a structured error response
   * with the exception's HTTP status and error code.
   *
