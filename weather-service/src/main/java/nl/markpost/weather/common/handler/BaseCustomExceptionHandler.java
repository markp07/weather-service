package nl.markpost.weather.common.handler;
 ...
 * <p>
 * Handles {@link nl.markpost.weather.common.exception.GenericException} and generic {@link Exception}.
 * Returns a structured {@link nl.markpost.weather.common.model.Error} response with appropriate HTTP status and error details.
 * </p>
 * <ul>
...
public class BaseCustomExceptionHandler {
  ...
  /**
   * Handles {@link nl.markpost.weather.common.exception.GenericException}.
